...
import { RQGActorSheet } from "./sheets/actor-sheet.mjs";
import { RQGItemSheet } from "./sheets/item-sheet.mjs";
...
Hooks.once('init', async function() {
  ...
  Items.registerSheet("rqg", RQGItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.rqg.rollItemMacro("${data.uuid}");`;
